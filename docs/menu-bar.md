...
- On first launch the app ships with a default set of stars (Codex Session, Z.ai Session, OpenCode Go Session) so the strip shows numbers right away. Change them anytime; Reset in Customize restores this set.
